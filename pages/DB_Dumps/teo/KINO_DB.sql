CREATE DATABASE  IF NOT EXISTS `kino_1` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `kino_1`;
-- MySQL dump 10.13  Distrib 8.0.18, for Win64 (x86_64)
--
-- Host: localhost    Database: kino_1
-- ------------------------------------------------------
...
CREATE TABLE `tbl_movies` (
  ...
  `m_age_r` tinyint(4) DEFAULT NULL COMMENT 'Възрастов рейтинг',
  ...
  `m_sub` bit(1) DEFAULT b'1' COMMENT 'Субтитри',
...
-- Dump completed on 2021-06-22 21:28:40
